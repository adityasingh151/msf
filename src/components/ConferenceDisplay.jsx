            ...
            <div key={conference.id} className="bg-white shadow-lg rounded-lg p-6 flex flex-col justify-between">
              <div>
                ...
                <p className="text-lg font-medium text-gray-700 mb-1">
                  <span className="text-gray-500">Date:</span> {conference.date}
                </p>
                <p className="text-lg font-medium text-gray-700">
                  <span className="text-gray-500">Location:</span> {conference.location}
                </p>
                <p className="text-lg font-medium text-gray-700">
                  <span className="text-gray-500">Description:</span> {conference.description}
                </p>
              </div>
            </div>
          ))}
